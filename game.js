function Bear(){
    this.dBear=100; // Number of pixels moved in one keypress
    ...
    //CHANGE 1  -  MADE DISPLAY AN ANONYMOUS FUNCTION
    this.display=function(){
        this.htmlElement.style.left = this.x + "px";
        this.htmlElement.style.top = this.y + "px";
        this.htmlElement.style.display="absolute"; //position ?, not display
    }

    //Move the bear by dx and dy steps in the horizontal and vertical directions.
    this.move = function (xDir,yDir){
        // this.setSpeed()
        this.x += this.dBear*xDir;
        this.y += this.dBear*yDir;
        //CHANGE 5 - The value of x and y should be checked AFTER ASSIGNMENT, NOT BEFORE
        this.fitBounds(); //we add this instruction to keep bear within board)
        this.display();
    }


    //keep bear within board
...
//Keyboard event handler to move the bear
function moveBear(e){
...
function start(){
    ...
    //instantiates the bear object
    bear= new Bear();
    //Change the speed of the bear
    ...
    bees=new Array();
    //Create bee objects
    //ADDITION - Added a event listener to change the number of bees
    makeBees()
